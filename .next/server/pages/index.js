...
const Status = () => {
  ...
  if (loading === false && (status === null || status === void 0 ? void 0 : status.discord_status) === "online" && (status === null || status === void 0 ? void 0 : status.listening_to_spotify) === false) return /*#__PURE__*/(0,jsx_runtime_.jsxs)(react_.Box, {
    display: "flex",
    flexWrap: "nowrap",
    float: "left",
    padding: "5",
  ...
  });else return /*#__PURE__*/(0,jsx_runtime_.jsxs)(react_.Box, {
    display: "flex",
    flexWrap: "nowrap",
    float: "left",
    padding: "5",
